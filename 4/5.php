...
background-size: cover;
	...
	<body>
			...
			<h1>STARTING FROM JAN ARRANGE THESE TENNIS GRAND SLAMS IN ORDER IN WHICH THEY ARE HELD IN A YEAR <h1>
			<BR>
			<H1>A. FRENCH OPEN B. WIMBLEDON C.US-OPEN D. AUSTRIALIAN OPEN </H1>
